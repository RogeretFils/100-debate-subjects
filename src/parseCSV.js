const rowCSV = `
  ...
  50|Justice et Loi|Déclin démographique|Comment palier à l'immense déclin démographique à venir, notamment en Asie ?|Quelles en sont les causes ?
  51||Mariage et choix|Voyez vous le fait d'avoir des enfant et de se marier comme un choix ou bien un devoir ?|
  52||Blocage des prix|L’État doit-il bloquer les prix des denrées de première nécessité, de l’essence et de l’énergie ?|
  53|Économie et Politique|Héritage|Doit-on taxer l'héritage ?|Si oui, à quel taux ?
  54|Économie et Politique|Prison|Doit-on s'inspirer du système carcéral singapourien ?|Doit-on rétablir les bagnes de Guyane ?
  55|Justice et Loi|Retraite|Doit-on privatiser les retraites ?|
  56|Économie et Politique|Femme pilote|Seriez vous comfortable si une femme pilotait votre avion ? Ou bien une femme présidente ?|
  57|Homme / Femme|Arme à feu|Le second amendement doit-il être instauré en France ?|Et pourquoi pas le port d'arme citoyen dissimulé ?
  58|Justice et Loi|Homme et égalité|Pensez vous que l’homme soit fait pour vivre dans une société égalitaire ?|Ou bien la pensée socialiste n’est elle pas une absurdité même au stade théorique comme immaginait Dostoïevski ? L'inégalité n'est elle pas essentielle et souhaitable ? La compétition n’est elle pas essentielle à notre développement ?
  59||Rap|Est-ce qu’écouter du rap ou du métal vous tire vers la médiocrité ?|
  60|Histoire et Culture|Défendre son pays|Vous bâteriez vous pour votre pays dans le cadre d'une guerre défensive ?|Si oui, Thorfinn a-t-il tort de vouloir « fuir » ?
  61||Croissance économique|Pensez vous que le niveau de vie en occident à réellement augmenter ces 50 dernières années ?|A-t-on su palier à la raréfaction des hydrocarbures ?
  62||Prohibition|Doit-on interdire la consommation de drogue ? De cigarette ? D’alcool ?|Lesquelles ? Si oui, comment doit-on lutter contre leur consommation ?
  63|Justice et Loi|Climat|Doit-on lutter contre le changement climatique ? Si oui, comment ?|Que penser des énergies renouvelables ? La réduction des déchets doit-elle se faire par une réduction de la production ? Avez-vous des solutions quant à l’utilisation non électrique du pétrole ?
  64|Écologie et Animaux|Inflation|Que cause l'inflation et comment y pallier ?|
  65|Économie et Politique|Éducation publique|L'éducation doit-elle rester publique ?|
  66|Économie et Politique|Valeur de la beauté|Sauveriez vous une vie ou bien une cathédrale ?|Si vous avez choisi la vie, doit-on réorienter tout budget lié à préservation du patrimoine vers la recherche médicale ?
  67||Femme et climat|Les femmes ne sont elles pas les plus grand ennemis de la planète, sélectionnant les hommes les plus polluants ?|L'attrait d'un homme n'est-il pas littéralement proportionnel à sa capacité à transformer son environnement ?
  68|Écologie et Animaux|Sélection féminine|Les femmes sont-elles des michetonneuses ?|Avez-vous des problèmes à respecter les femmes à cause de leur nature consensuel ? Une femme n’est est vraiment respectable que quand elle devient mère ?
  ...
  76||Pauvreté et crime|Pourquoi les populations immigrées sont-elles surreprésentées dans les prisons ?|La pauvreté est-elle la cause de la criminalité ? Ou bien est-ce la pauvreté relative ?
  77||Délinquance|La délinquance en France est-elle en augmentation ?|
  ...
  95||Euthanasie|L'euthanasie doit-elle être légale ?|Respectez-vous les individus réalisant des tentatives de suicide ?
